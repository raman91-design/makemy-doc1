...
/*========================Popup Settings===============================*/
    ...
    $options[] = array(
		'name' => __('Top-Header', 'options_check'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Email Link', 'options_check'),
		'desc' => __('Please fill link of mail', 'options_check'),
		'id' => 'email-link',
		'type' => 'text');

	$options[] = array(
		'name' => __('Email text', 'options_check'),
		'desc' => __('Please fill text of mail', 'options_check'),
		'id' => 'email-text',
		'type' => 'text');

	$options[] = array(
		'name' => __('Phone Text', 'options_check'),
		'desc' => __('Please fill phone text', 'options_check'),
		'id' => 'phone-text',
		'type' => 'text');

		$options[] = array(
		'name' => __('Phone Link', 'options_check'),
		'desc' => __('Please fill phone link', 'options_check'),
		'id' => 'phone-link',
		'type' => 'text');


	$options[] = array(
		'name' => __('header social links', 'options_check'),
		'type' => 'heading');

		$options[] = array(
		'name' => __('Facebook link', 'options_check'),
		'desc' => __('Please fill facebook link', 'options_check'),
		'id' => 'facebook-link',
		'type' => 'text');

		$options[] = array(
		'name' => __('Twitter link', 'options_check'),
		'desc' => __('Please fill link of twitter', 'options_check'),
		'id' => 'twitter-link',
		'type' => 'text');

		$options[] = array(
		'name' => __('Google link', 'options_check'),
		'desc' => __('Please fill googleplus link', 'options_check'),
		'id' => 'google-link',
		'type' => 'text');
